...
<article className="prose dark:prose-invert lg:prose-sm">

# Edgar Barrantes

> Problem solver and self thought shadowy super coder (has the Zapper NFT to prove it). Software engineer with 6 years of experience in the software industry.
...
_Remote - July 2022 - Present_

- [Cairo](https://www.cairo-lang.org/) development.
...
- Bounty hunting
  - Won Fair Data Society Gitcoin hackathon with a [Wikipedia to Swarm uploader](https://gitcoin.co/issue/fairdatasociety/wam/18/100027844).
